...
import { IMailer } from "../../../../../src/services/email_service/mailer";
import AuthenticationUsecase from "../../../../../src/services/users_service/usecase/auth";
import { IAuthserviceUtilities } from "../../../../../src/serviceUtility";
...
describe("AuthenticationUsecase", () => {
  ...
  describe("AuthenticationUsecase.LoginUser()", () => {
    it("should throw an error when passed invalid user credentials", async() => {
      ...
      //test for test error
    await  expect(() =>  authService.logInUser(userCredentials)).rejects.toThrowError(
